#!/usr/bin/env python3
"""
Windows power configuration utilities.

This module provides functions to query and set Windows power settings:
- Power Profile: The active power scheme/plan (e.g., "Balanced", "High Performance")
- Power Mode: The overlay slider setting (e.g., "Best Performance", "Balanced")
...
- POWER_MODE_BEST_PERFORMANCE: Constant for "Best Performance" mode
- POWER_MODE_BALANCED: Constant for "Balanced" mode
- POWER_MODE_BEST_POWER_EFFICIENCY: Constant for "Best Power Efficiency" mode
...
POWER_MODE_BEST_PERFORMANCE = "Best Performance"
POWER_MODE_BALANCED = "Balanced"
POWER_MODE_BEST_POWER_EFFICIENCY = "Best Power Efficiency"
...
_GUID_TO_MODE = {
    _OVERLAY_GUID_BEST_PERFORMANCE: POWER_MODE_BEST_PERFORMANCE,
    _OVERLAY_GUID_BEST_POWER_EFFICIENCY: POWER_MODE_BEST_POWER_EFFICIENCY,
    _OVERLAY_GUID_BALANCED: POWER_MODE_BALANCED,
}

# Mapping from power mode name to GUID (case-insensitive keys)
_MODE_TO_GUID = {
    POWER_MODE_BEST_PERFORMANCE.lower(): _OVERLAY_GUID_BEST_PERFORMANCE,
    POWER_MODE_BALANCED.lower(): _OVERLAY_GUID_BALANCED,
    POWER_MODE_BEST_POWER_EFFICIENCY.lower(): _OVERLAY_GUID_BEST_POWER_EFFICIENCY,
}
